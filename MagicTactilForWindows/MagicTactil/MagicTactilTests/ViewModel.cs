...
namespace MagicTactilTests
{
    ...
    public class ViewModel
    {
        ...
        [TestMethod]
        public void VMconversationmanager()
        {
            MagicTactilForWindows.Model.Network network = null;
            try
            {
        ...
        public void VMInnerBoard()
        {
            ...
            try
            {
                ...
                MagicTactilForWindows.ViewModel.VMInnerBoard deck = new MagicTactilForWindows.ViewModel.VMInnerBoard(network);
            }
            catch (Exception)
            {
                var message = "problem with VM";
