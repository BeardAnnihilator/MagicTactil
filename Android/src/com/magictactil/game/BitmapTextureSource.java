...
public class BitmapTextureSource extends BaseTextureAtlasSource implements IBitmapTextureAtlasSource 
{
    ...
    public BitmapTextureSource(Bitmap pBitmap)
    {
        ...
        {
                return new BitmapTextureSource(Bitmap.createBitmap(mColors, mTextureWidth, mTextureHeight, Bitmap.Config.ARGB_8888));
        }
}